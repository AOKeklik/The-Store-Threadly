                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="datatable table table-bordered">
                            ...
                            <tbody data-app-section="table-subscriber">
    ...
    <script>
        async function handlerChange (e,id,statusType) {
            try {
                ...
                const submit=await submitFrom({url:"{{ route('admin.subscriber.status.update') }}",formData})
        ...
        async function handlerDelete (e, id) {
            try {
                ...
                const submit=await submitFrom({url:"{{ route('admin.subscriber.delete') }}",formData})
                await fetchTable()
        ...
        function fetchTable(){
            $.ajax({
                type:"GET",
                url:"{{ route('admin.subscriber.section.table.view') }}",
