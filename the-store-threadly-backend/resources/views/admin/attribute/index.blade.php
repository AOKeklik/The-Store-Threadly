                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="parent" role="tabpanel" aria-labelledby="parent-tab">
                                    <form data-app-form="attribute-store">
                                        <div class="form-group mb-3">
                                            ...
                                            <input onchange="handlerChangeValue(event)" type="text" class="form-control" id="name" name="name">
                                ...
                                <div class="tab-pane fade" id="child" role="tabpanel" aria-labelledby="child-tab">
                                    <form data-app-form="attribute-child-store">
                                        ...
                                        <div class="form-group mb-3">
                                            <label>Value*</label>
                                            <input onchange="handlerChangeValue(event)" type="text" class="form-control" id="value" name="value">
                                        ...
                                        <div data-app-btn="attribute-child-store" class="form-group">
                                            <button onclick="handlerChildSubmit(event)" type="button" class="btn btn-primary">Submit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
@push("scripts")
    <script>
        ...
        async function handlerParentDelete (e,attribute_id) {
            try {
                e.preventDefault()
        ...
        async function handlerChildDelete (e,attribute_id,id) {
            try {
                e.preventDefault()
