...
<div class="main-content">
    <section class="section">
        <div class="section-header justify-content-between">
            <h1>Hero Slider</h1>
            <div class="ml-auto">
                <a href="{{ route("admin.slider.hero.view") }}" class="btn btn-primary"><i class="fas fa-eye"></i> Slider</a>
            </div>
        </div>
                    ...
                    <form class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <img src="{{ $slider->getImage() }}" alt="" style="max-height:250px;width:100%" class="d-block mx-auto">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group mb-4">
                                    ...
                                    <textarea id="desc" name="desc" class="form-control snote" cols="30" rows="10">{{ $slider->desc }}</textarea>
    ...
    <script>
        ...
        async function handlerSubmit (e) {
            try {
                ...
                const submit=await submitFrom({url:"{{ route('admin.slider.hero.update') }}",formData})
