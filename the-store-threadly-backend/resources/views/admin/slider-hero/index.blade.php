                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="datatable table table-bordered">
                                    ...
                                    <tbody data-app-section="table-slider-hero">
                                        @include("admin.slider-hero.table")
                                    </tbody>
                                </table>
                            </div>
                        </div>
    ...
    <script>
        ...
        async function handlerSubmit (e) {
            try {
                ...
                const submit=await submitFrom({url:"{{ route('admin.slider.hero.store') }}",formData})
                await fetchTable()
        ...
        async function handlerChange (e, id) {
            try {
                ...
                const submit=await submitFrom({url:"{{ route('admin.slider.hero.status.update') }}",formData})
        ...
        async function handlerDelete (e, id) {
            try {
                ...
                const submit=await submitFrom({url:"{{ route('admin.slider.hero.delete') }}",formData})
                await fetchTable()
        ...
        function fetchTable(){
            $.ajax({
                type:"GET",
                url:"{{ route('admin.slider.hero.section.table.view') }}",
                success:function(res){
                    $("[data-app-section=table-slider-hero]").html(res)
                    reloadJqueryPlugins ()
                },
                error: function(xhr) {
