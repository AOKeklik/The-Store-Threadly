...
@section("title", "Edit Variant Galery")
@section("content")
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group mb-3">
                                            <img style="height:200px" src="{{ $variantGalery->getImage() }}" alt="" class="mx-auto d-block">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="caption" name="caption" value="{{ $variantGalery->caption }}">
    ...
    <script>
        ...
        async function handlerSubmit (e) {
            try {
                ...
                const submit=await submitFrom({url:"{{ route('admin.product.variant.galery.update') }}",formData})
