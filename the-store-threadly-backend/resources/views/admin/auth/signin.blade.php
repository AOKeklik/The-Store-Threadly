            ...
            <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                <div class="card card-primary border-box">
                    ...
                    <div class="card-body card-body-auth">
                        <form data-app-form="signin-submit">
                            ...
                            <div class="form-group">
                                <button data-app-btn="signin-submit" type="submit" class="btn btn-primary btn-lg btn-block">
                                    Login
                                </button>
                            </div>
                            <div class="form-group">
                                <div>
                                    <a href="{{ route("admin.forget.view") }}">
                                        Forget Password?
                                    </a>
                                </div>
                            </div>
...
@push("scripts")
    <script>
        $(document).ready(function(){
            $(document)
                .on("click","[data-app-btn=signin-submit]",handlerSubmit)
