                            ...
                            <div class="table-responsive">
                                <table class="datatable table table-bordered">
                                    ...
                                    <tbody data-app-section="table-galery">
                                        @include("admin.product-galery.table")
                                    </tbody>
                                </table>
                            </div>
                        </div>
    ...
    <script>
        ...
        async function handlerSubmit (e, id) {
            try {
                ...
                const submit=await submitFrom({url:"{{ route('admin.product.galery.store') }}",formData})
                await fetchTable(id)
        ...
        async function handlerChange (e, id) {
            try {
                ...
                const submit=await submitFrom({url:"{{ route('admin.product.galery.status.update') }}",formData})
        ...
        async function handlerDelete (e, galery_id, product_id) {
            try {
                e.preventDefault()
                ...
                const submit=await submitFrom({url:"{{ route('admin.product.galery.delete') }}",formData})
        ...
        function fetchTable(productId){
            $.ajax({
                type:"GET",
                url:`/admin/product/galery/section/table/${productId}`,
