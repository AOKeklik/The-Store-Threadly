...
@section("title", "Edit Brand Slider")
@section("content")
<div class="main-content">
    <section class="section">
        <div class="section-header justify-content-between">
            <h1>Brand Slider</h1>
            <div class="ml-auto">
                <a href="{{ route("admin.slider.brand.view") }}" class="btn btn-primary"><i class="fas fa-eye"></i> Slider</a>
            </div>
        </div>
    ...
    <script>
        ...
        async function handlerSubmit (e) {
            try {
                ...
                const submit=await submitFrom({url:"{{ route('admin.slider.brand.update') }}",formData})
